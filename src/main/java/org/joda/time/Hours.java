...
public final class Hours extends BaseSingleFieldPeriod {
    ...
    public static final Hours ZERO = retrieveHours(0);
    /** Constant representing one hour. */
    public static final Hours ONE = retrieveHours(1);
    /** Constant representing two hours. */
    public static final Hours TWO = retrieveHours(2);
    /** Constant representing three hours. */
    public static final Hours THREE = retrieveHours(3);
    /** Constant representing four hours. */
    public static final Hours FOUR = retrieveHours(4);
    /** Constant representing five hours. */
    public static final Hours FIVE = retrieveHours(5);
    /** Constant representing six hours. */
    public static final Hours SIX = retrieveHours(6);
    /** Constant representing seven hours. */
    public static final Hours SEVEN = retrieveHours(7);
    /** Constant representing eight hours. */
    public static final Hours EIGHT = retrieveHours(8);
    /** Constant representing the maximum number of hours that can be stored in this object. */
    public static final Hours MAX_VALUE = retrieveHours(Integer.MAX_VALUE);
    /** Constant representing the minimum number of hours that can be stored in this object. */
    public static final Hours MIN_VALUE = retrieveHours(Integer.MIN_VALUE);
