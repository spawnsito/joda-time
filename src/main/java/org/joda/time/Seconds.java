...
public final class Seconds extends BaseSingleFieldPeriod {
    ...
    public static final Seconds ZERO = retrieveSeconds(0);
    /** Constant representing one second. */
    public static final Seconds ONE = retrieveSeconds(1);
    /** Constant representing two seconds. */
    public static final Seconds TWO = retrieveSeconds(2);
    /** Constant representing three seconds. */
    public static final Seconds THREE = retrieveSeconds(3);
    /** Constant representing the maximum number of seconds that can be stored in this object. */
    public static final Seconds MAX_VALUE = retrieveSeconds(Integer.MAX_VALUE);
    /** Constant representing the minimum number of seconds that can be stored in this object. */
    public static final Seconds MIN_VALUE = retrieveSeconds(Integer.MIN_VALUE);
    ...
    public static Seconds seconds(int seconds) {
        return retrieveSeconds(seconds);
    }
